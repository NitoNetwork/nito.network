...
$install_apps = "
<div class=\"mb-3\">
    <input type=\"text\" class=\"form-control\" value=\"sudo dnf update -y && sudo dnf install autoconf automake libtool pkg-config python3 python3-pip build-essential libssl-dev git yasm libzmq3-dev libpq-dev libgsl-dev git nano";
