...
$cd_userdir = "
<div class=\"mb-3\">
    <input type=\"text\" class=\"form-control\" value=\"sudo sh -c 'cd $home_folder/$folder_name && > script.sh && chmod 755 script.sh && nano script.sh'\" readonly>
</div>";
...
$run_script = "
<div class=\"mb-3\">
    <input type=\"text\" class=\"form-control\" value=\"sudo sh -c 'cd $home_folder/$folder_name && ./script.sh'\" readonly>
</div>";
