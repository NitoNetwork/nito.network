...
$install_apps = "
<div class=\"mb-3\">
    <input type=\"text\" class=\"form-control\" value=\"sudo apt update -y && sudo apt upgrade -y && sudo apt install";
...
$create_new_user = "
<div class=\"mb-3\">
    <input type=\"text\" class=\"form-control\" value=\"sudo /usr/sbin/useradd -m -s /bin/bash $username\" readonly>
</div>";

$url = $linux_aarch64_6;
$OUTPUT_FILE = basename($linux_aarch64_6);
...
$cd_userdir = "
<div class=\"mb-3\">   
    <input type=\"text\" class=\"form-control\" value=\"sudo sh -c 'cd $home_folder && > script.sh && chmod 755 script.sh && nano script.sh'\" readonly>
</div>";

$run_script = "
<div class=\"mb-3\">
    <input type=\"text\" class=\"form-control\" value=\"sudo sh -c 'cd $home_folder && ./script.sh'\" readonly>
</div>";
...
if [ \"\$CALCULATED_SHA256\" == \"$linux_aarch64_6_sha\" ]; then
    echo \"Checksum verification successful.\"
else
    echo \"Checksum verification failed! Expected $linux_aarch64_6_sha, but got \$CALCULATED_SHA256.\"
    exit 1
fi
...
$system_update = "
<div class=\"mb-3\">
    <input type=\"text\" class=\"form-control\" value=\"sudo apt update && sudo apt upgrade -y\" readonly>
</div>";
