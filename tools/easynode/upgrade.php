...
//0 = mainnet - 1 = testnet
$network_x = $_POST['network2'] ?? '';
if($network_x == 0 or $network_x == 1){$network = $network_x;}
if($network == 1){$networkname = "t-";}


$systemupdate_x = $_POST['systemupdate2'] ?? '';
if($systemupdate_x == 11){$systemupdate = $systemupdate_x;}
...
//text
$home_folder_x = $_POST['home_folder2'] ?? '';
